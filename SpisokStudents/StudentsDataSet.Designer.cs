...
namespace SpisokStudents {
    ...
    public partial class StudentsDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentsDataTable : global::System.Data.TypedTableBase<StudentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public StudentsRow AddStudentsRow(int id, System.DateTime data, string Name, string Surname, string Otch) {
        ...
        public partial class StudentsRow : global::System.Data.DataRow {
            ...
            public System.DateTime data {
                get {
                    return ((global::System.DateTime)(this[this.tableStudents.dataColumn]));
                }
                set {
                    this[this.tableStudents.dataColumn] = value;
                }
            }
            ...
            public string Otch {
                get {
                    return ((string)(this[this.tableStudents.OtchColumn]));
                }
                set {
                    this[this.tableStudents.OtchColumn] = value;
                }
            }
        }
...
namespace SpisokStudents.StudentsDataSetTableAdapters {
    ...
    public partial class StudentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Students] WHERE (([id] = @Original_id) AND ([data] = @Original" +
                "_data) AND ([Name] = @Original_Name) AND ([Surname] = @Original_Surname) AND ([O" +
                "tch] = @Original_Otch))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Students] ([id], [data], [Name], [Surname], [Otch]) VALUES (@i" +
                "d, @data, @Name, @Surname, @Otch);\r\nSELECT id, data, Name, Surname, Otch FROM St" +
                "udents WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Students] SET [id] = @id, [data] = @data, [Name] = @Name, [Surname] = @Surname, [Otch] = @Otch WHERE (([id] = @Original_id) AND ([data] = @Original_data) AND ([Name] = @Original_Name) AND ([Surname] = @Original_Surname) AND ([Otch] = @Original_Otch));
SELECT id, data, Name, Surname, Otch FROM Students WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::SpisokStudents.Properties.Settings.Default.StudentsConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, data, Name, Surname, Otch FROM dbo.Students";
        ...
        public virtual int Delete(int Original_id, System.DateTime Original_data, string Original_Name, string Original_Surname, string Original_Otch) {
        ...
        public virtual int Insert(int id, System.DateTime data, string Name, string Surname, string Otch) {
        ...
        public virtual int Update(int id, System.DateTime data, string Name, string Surname, string Otch, int Original_id, System.DateTime Original_data, string Original_Name, string Original_Surname, string Original_Otch) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(System.DateTime data, string Name, string Surname, string Otch, int Original_id, System.DateTime Original_data, string Original_Name, string Original_Surname, string Original_Otch) {
            return this.Update(Original_id, data, Name, Surname, Otch, Original_id, Original_data, Original_Name, Original_Surname, Original_Otch);
        }
    }
